...
export const FR = {
  ...
  loginpage: {
    ...
    form: {
      ...
      usernameValidationMessage: "Veuillez écrire un nom d'utilisateur",
      passwordValidationMessage: "Veuillez écrire un mot de passe",
  ...
  registerPage: {
    ...
    form: {
      ...
      usernameValidationMessage: "Veuillez écrire un nom d'utilisateur",
      emailValidationMessage: "Veuillez écrire un courriel",
      passwordValidationMessage: "Veuillez écrire un mot de passe",
      confirmPasswordValidationMessage: "Veuillez ré-écrire votre mot de passe",
