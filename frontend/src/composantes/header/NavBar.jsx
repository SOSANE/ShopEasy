                  ...
                  <ul className="grid w-[200px] gap-1 p-2">
                    <li>
                      <NavigationMenuLink asChild>
                        <Link
                          to={PATH.profile}
                          className="flex w-full items-center rounded-md p-3 text-sm font-medium text-stone-950 hover:bg-stone-200"
                        >
                          {LOCALIZE.header.myProfile}
                        </Link>
                      </NavigationMenuLink>
                    ...
                    <li>
                      <button
                        ...
                        className="w-full bg-transparent text-sm font-medium text-stone-950 hover:bg-stone-200"
                      >
              ...
              <NavigationMenuLink asChild>
                <Link
                  ...
                  className={`${navigationMenuTriggerStyle()} ${
                    location.pathname === PATH.login ? "border border-black" : ""
                  }`}
                >
